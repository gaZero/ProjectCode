...
<body>
	...
	<h2>게시물 삭제</h2>
		...
		<div align="center">
			<h4>정말 삭제하시겠슴니까?</h4>
			<a href="realdeleteBoard.do?no=${no}" class="btn btn-default">예</a>
			<a href="detailBoard.do?no=${no}" class="btn btn-default">아니오</a>
		</div>
<!-- start modal -->
  ...
  <!-- start Navigation -->
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
      <div class="container">
        <a class="navbar-brand" href="#"><img src="../resources/img/mylogo.png" width="150" id="imglogo"></a>
