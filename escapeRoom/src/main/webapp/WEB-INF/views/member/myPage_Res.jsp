		...
		success : function(data){
			...
			if(list.length != 0) {
				$.each(list, function(i,v){
					...
					var td_cancle = $("<td></td>").attr({"rowspan":"4", "align":"center"}).appendTo(tr1);
					var cancle = $("<button style='background-color:#3755AB;color:white;'></button>").html("예약취소").appendTo(td_cancle);
				...
				$("<h2></h2>").html("예약정보가 없습니다.").appendTo("#div");
			}
		}	
	});	// ajax end
});
...
<!-- end modal -->
  ...
  <!-- start Navigation -->
    ...
    <div id="center">
		<h1><font color="#FFE400">나의 예약정보</font></h1>
		<br>
		<div id="div"></div>
    </div>
	...
	<div id="layer_fixed">
		...
		<a href="deleteMemberInfo.do?id=${id }" class="list-group-item"><img src="../resources/img/icons/my_delete.JPG" width="25" height="25">&nbsp; 회원 탈퇴 </a>
